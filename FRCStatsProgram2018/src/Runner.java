...
public class Runner {
	...
	public static void main(String[] args) throws IOException {
		...
		int new0_open1 = JOptionPane.showOptionDialog(null, "Create new competition" + " or open existing competition.",
				"Select", JOptionPane.INFORMATION_MESSAGE, 0, null, buttons, buttons[1]);
