...
public class DataTable extends JFrame {
    ...
    public DataTable(Competition comp)                       
    {
        ...
        String[] columnNames = {"Team", "Avg A Scale", "Avg A Switch", "Avg T Scale", "Max T Scale", "Avg T Switch", "Max T Switch", "Avg EZ", "Max EZ", "Avg Climb", 
        		"Portal", "Floor"};    
        ...
        for(int i = 0; i < competition.robots.size(); i++){ 
            ...
            data[i][6] = competition.robots.get(i).avg_t_scale;
